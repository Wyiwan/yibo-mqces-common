...
public class MessageServiceImpl extends AbstractBaseService<MessageDao, Message> implements MessageService {
    ...
    public void insert(Message message){
        ...
        FileUploadUtils.saveFileUpload(message.getId(), "msg_file");
    }
    ...
    @Override
    @Transactional(readOnly = false)
    public void updateNull(Message message){
        super.updateNull(message);
        FileUploadUtils.saveFileUpload(message.getId(), "msg_file");
    }
    ...
    public void deleteByIds(List list){
        ...
        FileUploadUtils.delFileUploadByBizKeys(list);
    }
}