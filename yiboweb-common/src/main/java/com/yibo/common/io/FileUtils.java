...
import com.yibo.common.codec.EncodeUtils;
...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static String readFileToString(String classResourcePath){
		...
		try {
			...
			logger.warn("Error file restful: {}", e.getMessage());
		}finally{
	...
	public static void writeToFileByImageBase64(String fileName, String imageBase64){
		String base64 = com.yibo.common.lang.StringUtils.substringAfter(imageBase64, "base64,");
		if (com.yibo.common.lang.StringUtils.isBlank(base64)){
			return;
		}
	...
	public static String downFile(File file, HttpServletRequest request, HttpServletResponse response, String fileName){
		...
		try {
			response.addHeader("Content-Disposition", "attachment; filename=\"" + 
					EncodeUtils.encodeUrl(com.yibo.common.lang.StringUtils.isBlank(fileName) ? file.getName() : fileName) + "\"");
	...
	public static String path(String path){
		String p = com.yibo.common.lang.StringUtils.replace(path, "\\", "/");
		p = com.yibo.common.lang.StringUtils.join(com.yibo.common.lang.StringUtils.split(p, "/"), "/");
		if (!com.yibo.common.lang.StringUtils.startsWithAny(p, "/") && com.yibo.common.lang.StringUtils.startsWithAny(path, "\\", "/")){
			p += "/";
		}
		if (!com.yibo.common.lang.StringUtils.endsWithAny(p, "/") && com.yibo.common.lang.StringUtils.endsWithAny(path, "\\", "/")){
			p = p + "/";
		}
	 ...
	 * 获取文件名，不包含扩展名
	 * @param fileName 文件名
	 * @return 例如：d:\files\springboot.jpg  返回：d:\files\springboot
	 */
	 ...
	 * 获取文件扩展名(返回小写)
	 * @param fileName 文件名
	 * @return 例如：springboot.jpg  返回：  jpg
	 */
	public static String getFileExtension(String fileName) {
		...
		return com.yibo.common.lang.StringUtils.lowerCase(fileName.substring(fileName.lastIndexOf(".") + 1));
	}
	...
	public static String getFileExtensionByImageBase64(String imageBase64){
		...
		String type = com.yibo.common.lang.StringUtils.substringBetween(imageBase64, "data:", ";base64,");
		if (com.yibo.common.lang.StringUtils.inStringIgnoreCase(type, "image/jpeg")){
			extension = "jpg";
		}else if (com.yibo.common.lang.StringUtils.inStringIgnoreCase(type, "image/gif")){
			extension = "gif";
		}else{
			extension = "png";
		}
    ...
    public static String getProjectPath(){
		...
		// 取不到，取当前工作路径
		if (com.yibo.common.lang.StringUtils.isBlank(projectPath)){
    ...
    public static String getWebappPath(){
		...
		// 取不到，取当前工作路径
		if (com.yibo.common.lang.StringUtils.isBlank(webappPath)){
