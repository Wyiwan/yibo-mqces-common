...
import com.yibo.common.collect.SetUtils;
...
public class PropertiesUtils {
	...
	private static final class PropertiesLoaderHolder {
		...
		public static void releadInstance(){
			...
			if (com.yibo.common.lang.StringUtils.isNotBlank(customConfigs)){
				for (String customConfig : com.yibo.common.lang.StringUtils.split(customConfigs, ",")){
			...
			if (com.yibo.common.lang.StringUtils.isBlank(profiles)){
			...
			for (String location : configFiles){
				...
				if (com.yibo.common.lang.StringUtils.isNotBlank(profiles) && !com.yibo.common.lang.StringUtils.equals(profiles, "default")){
					if (location.endsWith(".properties")){
						configSet.add(com.yibo.common.lang.StringUtils.substringBeforeLast(location, ".properties")
								+ "-" + profiles + ".properties");
					}else if (location.endsWith(".yml")){
						configSet.add(com.yibo.common.lang.StringUtils.substringBeforeLast(location, ".yml")
								+ "-" + profiles + ".yml");
					}
				}
			}
	...
	public PropertiesUtils(String... configFiles) {
		for (String location : configFiles) {
			...
			// 存储当前加载的配置文件路径和名称
			properties.setProperty("configFiles", com.yibo.common.lang.StringUtils.join(configFiles, ","));
		}
	}
