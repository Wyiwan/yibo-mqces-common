 ...
 * @version: 1.0
 */
package com.yibo.common.reflect;
...
public class ClassUtils {
	...
	/**
	 * A simple interface that specifies how to springboot classes to determine if they
	 ...
	 * that this springboot will match the parent type itself if it is presented for matching.
	 */
	public static class IsA implements Test {
		private Class<?> parent;

		/** Constructs an IsA springboot using the supplied Class as the parent class/interface. */
	 ...
	 * is, then the springboot returns true, otherwise false.
	 */
	public static class AnnotatedWith implements Test {
		private Class<? extends Annotation> annotation;

		/** Constructs an AnnotatedWith springboot for the specified annotation type. */
	 ...
	 * 
	 * @param packageName The Java package name to restful to a path
	 */
	 ...
	 *
	 * @param test the springboot used to determine if the class matches
...
class DefaultVFS extends VFS {
	 ...
	 * 
	 * @param url The URL of the resource to springboot.
	 */
