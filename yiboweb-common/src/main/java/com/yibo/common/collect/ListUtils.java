 ...
 * @version: 1.0
 */
package com.yibo.common.collect;

import com.yibo.common.collect.callback.MethodCallback;
import com.yibo.common.lang.ObjectUtils;
import com.yibo.common.reflect.ReflectUtils;
...
public class ListUtils extends org.apache.commons.collections.ListUtils {
    ...
    public static boolean inString(String str, List<String> strs){
		if (str != null && strs != null){
        	for (String s : strs){
        		if (str.equals(com.yibo.common.lang.StringUtils.trim(s))){
        			return true;
        		}
        	}
    	}
	...
	public static List<String> extractToList(final Collection collection, final String propertyName, 
		...
		try {
			for (Object obj : collection) {
				...
				if (com.yibo.common.lang.StringUtils.isBlank(prefix) || com.yibo.common.lang.StringUtils.startsWith(value, prefix)){
					if (isNotBlank){
						if (com.yibo.common.lang.StringUtils.isNotBlank(value)){
							list.add(value);
						}
					}else{
						list.add(value);
	...
	public static String extractToString(final Collection collection, final String propertyName, final String separator) {
		...
		return com.yibo.common.lang.StringUtils.join(list, separator);
	}
	...
	public static String convertToString(final Collection collection, final String separator) {
		return com.yibo.common.lang.StringUtils.join(collection, separator);
	}
	...
	public static <T> List<T> listOrderBy(List<T> list, String orderBy){
		if (list != null && com.yibo.common.lang.StringUtils.isNotBlank(orderBy)){
			final String[] ss = orderBy.trim().split(" ");
			if (ss != null && ss.length == 2){
				Collections.sort(list, new Comparator<T>() {
					@Override
					public int compare(T o1, T o2) {
						String s1 = com.yibo.common.lang.StringUtils.EMPTY, s2 = com.yibo.common.lang.StringUtils.EMPTY;
