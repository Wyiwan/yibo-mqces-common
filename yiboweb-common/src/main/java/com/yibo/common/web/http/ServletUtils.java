 ...
 * @version: 1.0
 */
package com.yibo.common.web.http;

import com.yibo.common.collect.MapUtils;
import com.yibo.common.io.PropertiesUtils;
import com.yibo.common.lang.StringUtils;
import com.yibo.common.mapper.JsonMapper;
...
public class ServletUtils {
    ...
    public static boolean isStaticFile(String uri){
		if (staticFiles == null){
			...
			if (staticFiles == null){
				try {
					throw new Exception("检测到“jeesite.yml”中没有配置“controller.staticFile”属性。"
